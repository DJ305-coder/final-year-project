...
<!-- Content Wrapper. Contains page content -->
     ...
     <div class="row change-password-page-wrap">
       ...
       <!--</h1>-->
         ...
         <div class="box box-primary">
           ...
           <!-- /.box-header -->
           <!-- form start -->
           <form action="{{url('change-password')}}" method="POST" id="changePasswordForm" role="form">
 ...
 @section('script')
    ...
    <script src="{{ URL::asset('assets/admin_panel/js/validations/custom/admin/changepassword.js')}}"></script>
 <script>
     <!-- Password hide show -->
