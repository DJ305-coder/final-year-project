        ...
        <div class="row no-margin">
            ...
            <div class="col-md-12 no-pad">
                <section class="content-header">
                    <h1>Delivered Online Shopping Order List
                        <div class="pull-right">
                            ...
                            <a href="<?= site_url('admin/orders/delivered-online-orders') ?>">
                                <button type="button" class="btn btn-primary tab-p" style="padding: 6px 12px !important;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= site_url('admin/orders/vw-delivered-online-orders') ?>" class="btn btn-primary btn-xs" title="Add Stock">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
