        ...
        <div class="row no-margin">
            ...
            <div class="col-md-12 no-pad">
                <section class="content-header">
                    <h1>Pending Online Shopping Order List
                        <div class="pull-right">
                            <a href="{{route('orders_online_orders')}}">
                                <button type="button" class="btn btn-info tab-p" style="padding: 6px 12px !important;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{route('orders_online_orders')}}" class="btn btn-primary btn-xs" title="Add Stock">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
